...
; -----------------------------------------------------------------------------
; Single motor — Level A (2026-05-25). Mirrors the validated tests/dark1-
; engine-v3.asm layout for Phase 1 (canonical hook-mode loop in the 0xA60C
; enemy hole + converged state vars at 0xA6A1 + PANTAL preload patch), and
; stashes Phase 2 as a converged binary image (build/phase2-converged.bin,
; built off tests/dark2-engine-v3.asm) in banks 1/3/4 — drops the cassette
; `dark2.sna` dependency.
;
...
; Regenerated by build.sh from tests/dark2-engine-v3.asm — no more dark2.sna
...
; Phase 2 standalone's boot stub (dark2-engine-v3.asm) occupies 0x5B00-0x5B0B
