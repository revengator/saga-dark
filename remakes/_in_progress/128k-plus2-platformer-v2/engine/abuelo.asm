...
PODER    LD     A,(ABUELO_OFF) ; VAR12 (abuelo_off)
         CP     0
         RET    NZ
         ...
         LD     A,2
         LD     (DAS),A
         LD     A,(VAR10)      ; VAR10 (counter)
         DEC    A
         LD     (VAR10),A
         CP     0
         RET    NZ
         LD     A,40
         LD     (VAR10),A      ; reset counter a 40
         LD     HL,TP0         ; TP0 (tabla pasos abuelo)
         LD     A,(VAR0)
         AND    %00111111
         LD     B,0
         LD     C,A
         ...
         CP     0
         JP     Z,STOP
         LD     (VAR13),A      ; VAR13 = primer byte de TP0[VAR0]
         LD     (VAR2),A       ; VAR2 = lo mismo
...
STOP     LD     A,1
         LD     (ABUELO_OFF),A ; VAR12 = 1
         RET


; --- ABUELO — main loop del NPC abuelo --------------------------------------

ABUELO   LD     A,(VAR13)      ; VAR13
         CP     0
         RET    Z
