...
; 1 PANTALLA ABUELO
            ...
            CALL    anim_off    ; Paramos animacion IM2 (la musica sigue)
            
; PANTALLA 2 CIUDAD 1

CIUDAD1     LD      A,SP_PPANT2
            CALL    show_pantalla
            CALL    CLS
            ...
            LD      (current_anim),HL ; antes: LD (65022),HL — master_im2 lee aqui
            CALL    RAINM2
...
PANT1: DEFS 2269, 0   ; PANT1..PANT10 ZX0-stashed in bank 6 (forward), 1224 B compressed
PANT2 EQU PANT1 + 195
PANT3 EQU PANT1 + 422
PANT4 EQU PANT1 + 617
PANT5 EQU PANT1 + 876
PANT6 EQU PANT1 + 1103
PANT7 EQU PANT1 + 1362
PANT8 EQU PANT1 + 1750
PANT9 EQU PANT1 + 2009
PANT10 EQU PANT1 + 2139
...
; IMPRIMIMOS CIUDAD PEQUE�A 32160
