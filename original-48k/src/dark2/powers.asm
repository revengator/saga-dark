...
; Variables:
;   VAR7  (0xA6AB) — fuerza actual (0..3)
;   VAR1  (0xA6A2?) — fase de power-up actual
;   PAR1  (0x7BFB) — contador de parpadeo (data dentro del módulo)
;   VAR16 (0xA6A9?) — variable de estado
;
...
PODER2   CALL   0xA89F        ; rutina externa en main_tail (etiqueta TBD)
...
PODER4   LD     A,(0xA6A2)    ; POD4 - variable
         INC    A
         LD     (0xA6A2),A
         CP     2
         CALL   Z,POD44
...
POD44    LD     A,1
         LD     (0xA6A2),A
         LD     A,0
         LD     (0xA6A9),A    ; otra variable de estado
         RET


; --- PODERS — Dispatcher principal según VAR16 (0xA6A9) -------------------
