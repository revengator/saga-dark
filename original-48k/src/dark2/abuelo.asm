...
;
; Variables:
;   VAR12 (0xA6A7) — abuelo_off (1=abuelo desactivado tras hablar)
;   VAR10 (0xA6A8) — contador interno
;   VAR13 (0xA6AA) — estado del abuelo (0=quieto, !=0=activo)
;   VAR2  (0xA6AE) — guarda copia previa de la fase de poderes
;   VAR1  (0xA6A9) — variable de fase poderes
;   TP0   (0xA77D) — tabla de pasos del abuelo (3 bytes × 64 pantallas)
; =============================================================================
...
PODER    LD     A,(0xA6A7)     ; VAR12 (abuelo_off)
         CP     0
         RET    NZ
         ...
         LD     A,2
         LD     (DAS),A
         LD     A,(0xA6A8)     ; VAR10 (counter)
         DEC    A
         LD     (0xA6A8),A
         CP     0
         RET    NZ
         LD     A,40
         LD     (0xA6A8),A     ; reset counter a 40
         LD     HL,0xA77D      ; TP0 (tabla pasos abuelo)
         LD     A,(VAR0)
         AND    %00111111
         LD     B,0
         LD     C,A
         ...
         CP     0
         JP     Z,STOP
         LD     (0xA6AA),A     ; VAR13 = primer byte de TP0[VAR0]
         LD     (0xA6AE),A     ; VAR2 = lo mismo
